...
import ua.nure.yesipov.model.WumpusWorld;
...
public class WorldAgent extends Agent {
    ...
    private class PerceptReplyBehaviour extends OneShotBehaviour {
        ...
        private String generatePercept() {
            ...
            reply.append(ap.isStench() ? 1 : 0);
            reply.append(" ");
            reply.append(ap.isBreeze() ? 1 : 0);
            reply.append(" ");
            reply.append(ap.isGlitter() ? 1 : 0);
            reply.append(" ");
            reply.append(ap.isBump() ? 1 : 0);
            reply.append(" ");
            reply.append(ap.isScream() ? 1 : 0);
